...
// Atributo que define la velocidad de un automóvil
     ...
     */
    AutomovilV2(String marca, int modelo, int motor, tipoCom tipoCombustible, tipoA tipoAutomóvil, int númeroPuertas, int cantidadAsientos, int velocidadMáxima, tipoColor color) {
        this.marca = marca;
        this.modelo = modelo;
        this.motor = motor;
    ...
    AutomovilV2(String marca, int modelo, int motor, boolean automatico, tipoCom tipoCombustible, tipoA tipoAutomóvil, int númeroPuertas, int cantidadAsientos, int velocidadMáxima, tipoColor color) {
        this.marca = marca;
        this.modelo = modelo;
        this.motor = motor;
...
máxima */
            ...
            velocidadActual = velocidadActual + incrementoVelocidad;
            System.out.println("Disminuya la velocidad inmediatamente,\nSe le impondra una multa por exceso de velocidad");
            multas++;
        }
    }
...
se genera mensaje */
    ...
    void imprimir() {
        ...
        System.out.println("Es automatico = " + ((automatico == true) ? "Si" : "No"));
        System.out.println("Numero de multas = " + multas);
    }
